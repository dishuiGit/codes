			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="order_show_msg">${om.supplier.name}</td>
						<td height="30">订单类别:</td>
						<td class="order_show_msg">${om.type}</td>
						<td>提货方式:</td>
						<td class="order_show_msg">${om.supplier.needsView}</td>
						<td>订 单 号:</td>
						<td class="order_show_msg" colspan="2">${om.orderNum}</td>
					</tr>
					<tr>
						<td>联&nbsp;系&nbsp;人:</td>
						<td class="order_show_msg">${om.supplier.contact}</td>
						<td>联系方式:</td>
						<td class="order_show_msg">${om.supplier.tele}</td>
						<td>商品总量:</td>
						<td class="order_show_msg">${om.totalNum}</td>
						<td>地&nbsp;&nbsp;&nbsp;&nbsp;址:</td>
						<td class="order_show_msg">${om.supplier.address}</td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
			<div class="square-order">
				...
				<table width="100%">
					<tr>
						...
						<s:if test="om.orderState != 141">
							<a href="transport_endTask.action?om.uuid=${om.uuid}" style="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								结&nbsp;&nbsp;单
							</a>
						</s:if>
						<s:else>

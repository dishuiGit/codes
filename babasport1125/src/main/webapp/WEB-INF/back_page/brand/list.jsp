...
function optDelete(name,isDisplay,pageNo){
	...
	$("#jvForm").
	attr("action","/brand/deleteBrands.do?name=" + name + "&isDisplay=" + isDisplay + "&pageNo=" + pageNo)
	.attr("method","post")
	.submit();
}
</script>
...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<c:forEach items="${pagination.list }" var="entry">
		...
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" href="toEdit.do?id=${entry.id }">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="#">删除</a>
			</td>
		</tr>
	</c:forEach>

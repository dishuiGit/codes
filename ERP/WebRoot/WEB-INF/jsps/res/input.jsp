				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<s:textfield size="77" name="res.name"/>
				      </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      <s:textfield size="77" name="res.url"/>
				      </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				...
				<div style="margin:1px auto auto 1px;">
					<table width="100%"  border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    ...
					    <td>&nbsp;</td>
					    <td><a href="res_save.action"><img src="images/order_tuo.gif" border="0" /></a></td>
					    <td>&nbsp;</td>

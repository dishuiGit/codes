  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<s:textfield size="25" name="emp.userName" />
				      </td>
				      <td width="18%"align="center">真实姓名</td>
				      <td width="32%">
				      	<s:textfield size="25" name="emp.name" />
					  </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<s:textfield size="25" name="emp.pwd" />
				      </td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<s:textfield size="25" name="emp.email" />
				      <td align="center">电话号码</td>
				      <td>
				      	<s:textfield size="25" name="emp.tele" />
					  </td>
				     </tr>
				      <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<select name="emp.gender" style="width:190px">
				      ...
				      <td>
				      	<s:textfield size="25" name="emp.address" />
					  </td>
				    </tr>
				     <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<input type="text" size="25" onfocus="c.showMoreDay=false;c.show(this);" readonly="true" value="${emp.birthdayView }"/>
				      	<s:hidden name="emp.birthday"/>
					  </td>
				      <td align="center">所属部门</td>
				      <td>
				      	<s:select list="depList" name="emp.dm.uuid" listKey="uuid" listValue="name">
				      	</s:select>
					  </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">

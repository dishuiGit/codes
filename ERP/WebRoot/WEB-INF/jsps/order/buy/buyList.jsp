...
<div class="content-right">
	...
	<div class="content-text">
		<s:form action="order_buyOrderList" method="post"> 
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td> 
							<s:select name="oqm.orderState" list="@cn.itcast.erp.invoice.order.vo.OrderModel@orderStateBuyMap" headerKey="-1" headerValue="----请-选-择----" cssClass="kuan" cssStyle="width:113px"></s:select>
						</td>
						<td>下单人:</td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="orderList">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								<a href="order_inDetialList.action?om.uuid=${uuid}" class="xiu">详情</a>
							</td>

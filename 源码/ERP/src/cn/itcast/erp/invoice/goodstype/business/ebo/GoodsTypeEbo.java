...
public class GoodsTypeEbo implements GoodsTypeEbi{
	...
	public List<GoodsTypeModel> getAllUnionBySmAndDelUsed(Long supplierUuid,Set<Long> uuids) {
		return goodsTypeDao.getBySmUuidAndGmUuidNotInSet(supplierUuid,uuids);
	}

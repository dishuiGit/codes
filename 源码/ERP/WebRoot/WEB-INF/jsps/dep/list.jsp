...
<script type="text/javascript">
	...
	*/
	function showMsg(msg,uuid){
		...
		//如何操作main页面中的lock对象
		//操作主页上面的lock对象
		//当前操作是在iframe内嵌的页面中，操作iframe外的东西
		top.lock.show();
		//显示信息DIV
		top.$('context-msg').style.display = "block";
		//修改文字
	...
	<div class="content-text">
		<s:form action="dep_list" method="post">
			...
			<div class="square-order">
				<!-- 如果集合depList中没有元素，显示提示信息 -->
				<%-- --<s:property value="#depList.size()"/>--
				--<s:property value="7"/>--
				--<s:property value="#depList.size() == 7"/>-- --%>
							...
							<tr align="center" bgcolor="#FFFFFF">
								...
								<td>
									...
									<span style="line-height:12px; text-align:center;"> 
										...
										-->
										<a href="javascript:void(0)" class="xiu" onclick="showMsg('是否删除该部门？',${uuid})">删除</a>

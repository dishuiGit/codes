...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<s:form action="menu_save.action" method="post">
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      <s:select name="mm.parentMM.uuid" list="parentMMList" listKey="uuid" listValue="name"></s:select>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <s:textfield size="25" name="mm.url"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>

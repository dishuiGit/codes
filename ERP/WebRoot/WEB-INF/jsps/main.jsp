	...
	<div class="container">
		<div class="head">
			<div class="head-left">
				...
				<span style="color:#4a940d">${loginEmp.name }</span>
			</div>
			...
			<div class="left">
				...
				<div class="left-bottom">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td><a class="hei" target="main" href="supplier_list.action">&nbsp;&nbsp;&nbsp;&nbsp;供应商</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="goodsType_list.action">&nbsp;&nbsp;&nbsp;&nbsp;商品类别</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="goods_list.action">&nbsp;&nbsp;&nbsp;&nbsp;商品</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="#">采购管理</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="order_buyList.action">&nbsp;&nbsp;&nbsp;&nbsp;采购订单</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" >&nbsp;&nbsp;&nbsp;&nbsp;采购退货</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="order_buyCheckList.action">&nbsp;&nbsp;&nbsp;&nbsp;采购审批</a></td>
							</tr>
							<tr>
							...
							<tr>
								<td><a class="hei" target="main" href="transport_taskList.action">&nbsp;&nbsp;&nbsp;&nbsp;运输任务指派</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="transport_queryTasks.action">&nbsp;&nbsp;&nbsp;&nbsp;运输任务查询</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="#">仓库管理</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="store_list.jsp">&nbsp;&nbsp;&nbsp;&nbsp;库存查询</a></td>
							</tr>
							<tr>
								<td><a class="hei" target="main" href="store_inList.action">&nbsp;&nbsp;&nbsp;&nbsp;入库</a></td>
							</tr>
							<tr>
							...
							<tr>
								<td><a class="hei" target="main" href="bill_buyBillList.action">&nbsp;&nbsp;&nbsp;&nbsp;进货报表</a></td>
							</tr>
							<tr>
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="82%"><img src="images/icon_1.gif" />&nbsp; <a
							class="lanyo" href="http://www.itcast.cn">传智播客 蓝源信息技术 2015</a></td>

			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>性&nbsp;&nbsp;&nbsp;&nbsp;别</td>
						<td>
							<s:select name="eqm.gender" list="@cn.itcast.erp.auth.emp.vo.EmpModel@gender_map" cssClass="kuan" headerKey="-1" headerValue="---请选择---" />
						</td>
					...
					<tr>
						...
						<td>部门名称</td>
						<td>
							<s:select list="depList" name="eqm.dm.uuid" listKey="uuid" listValue="name" headerKey="-1" headerValue="----请-选-择----" />
						</td>

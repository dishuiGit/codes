	...
	<div class="content-text">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>订单状态:</td>
						<td class="order_show_msg">${om.orderStateView}</td>
						<td>商品总量:</td>
			...
			<div class="square-order">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="om.odms">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="right">${subTotalView} 元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
					</s:iterator>
					<tr align="right">
				...
				<table width="100%">
					<tr align="center">
						<td width="50%">
							<a href="order_approve.action?om.uuid=${om.uuid}" style="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								通&nbsp;&nbsp;过
							</a>
						</td>
						<td width="50%">

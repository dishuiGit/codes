			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="8%">供应商:</td>
						<td width="17%"><s:textfield size="18" name="sqm.name" /></td>
						<td width="8%">联系人:</td>
						<td width="17%"><s:textfield size="18" name="sqm.contact" /></td>
						<td width="12%">
					...
					<tr>
						<td height="30">&nbsp;</td>
						<td>电话:</td>
						<td><s:textfield size="18" name="sqm.tele" /></td>
						<td>提货方式：</td>
						<td>
							<s:select name="sqm.needs" list="@cn.itcast.erp.invoice.supplier.vo.SupplierModel@needsViewMap" cssClass="kuan"></s:select>
						</td>
						<td>
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								...
								<span style="line-height:12px; text-align:center;"> 
									<a href="supplier_input.action?sm.uuid=${uuid }" class="xiu">修改</a>
								</span> 
